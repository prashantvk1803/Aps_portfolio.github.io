...
<div style="display: flex; flex-direction: column; align-items: center;">
  <img src="app1.png" alt="Apple Music Business Model 1" style="width: 98%; height: 50%; margin-bottom: 20px;"/>
