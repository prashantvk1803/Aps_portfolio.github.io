...
<div style="display: flex; align-items: center;">
  <img src="spotify.png" alt="Spotify Business Model" style="width: 95%; height: 50%; margin-right: 50px;"/>
  <div>
...
<div style="display: flex; flex-direction: column; align-items: center;">
  <img src="app1.png" alt="Apple Music Business Model 1" style="width: 95%; height: 50%; margin-bottom: 20px;"/>
  <img src="app2.png" style="width: 95%; height: 50%; margin-bottom: 20px;"/>
